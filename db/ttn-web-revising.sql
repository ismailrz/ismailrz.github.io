...
--
-- Host: localhost
-- Generation Time: Oct 17, 2019 at 12:26 PM
...
CREATE TABLE `badges` (
  ...
  `minimum_certificate` int(11) NOT NULL DEFAULT '1',
  `minimum_course` int(11) NOT NULL DEFAULT '1',
  `total_fees` int(11) NOT NULL DEFAULT '0',
  `created_at` datetime NOT NULL,
  `modified_at` datetime NOT NULL
...
CREATE TABLE `certificates` (
  ...
  `minimum_mendatory_course` int(11) NOT NULL DEFAULT '1',
  `minimum_course` int(11) NOT NULL DEFAULT '1' COMMENT 'Mininum course to be certified',
  `created_at` datetime NOT NULL,
  `modified_at` datetime NOT NULL
...
CREATE TABLE `events` (
  `id` int(11) NOT NULL,
  `user_id` int(11) NOT NULL COMMENT 'Who is creating the event',
