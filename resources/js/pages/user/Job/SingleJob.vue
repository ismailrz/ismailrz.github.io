                                    ...
                                    <div class="posts-section">
                                        ...
                                        <div>
                                            <span style="font-size: 14px;" class="badge badge-pill badge-primary mr-2">
                                                ...
                                                <div v-if="job.job_type_id == 10">Part Time</div>
                                                <div v-if="job.job_type_id == 20">Remote</div>
                                            </span>
                                        ...
                                        <div class="row mt-4">
                                            <div class="col pl-0">
                                                <h2 class="mb-2">Responsibilities:</h2>
                                                <p class="text-muted" style="line-height: 24px">{{job.responsibilities}}</p>
                                            </div>
                                        </div>
                                        <div class="row mt-4">
                                            <div class="col pl-0">
                                        ...
                                        <div class="row mt-4">
                                            <div class="col pl-0">
                                                <h2 class="mb-2">Other Benefits:</h2>
                                                <p class="text-muted">{{job.other_benefits}}</p>
                                            </div>
                                        </div>
                                        <div class="row mt-4">
                                            <div class="col pl-0">
                                                <h2 class="mb-2">Experience:</h2>
                                                <p class="text-muted">{{job.minimum_experience}} - {{job.maximum_experience}}</p>
                                            </div>
                                        </div>
                                        <div class="row mt-4">
                                            <div class="col pl-0">
                                                <h2 class="mb-2">Age:</h2>
                                                <p class="text-muted">{{job.minimum_age}} - {{job.maximum_age}}</p>
                                            </div>
                                        </div>
                                        <div v-show="job.special_instruction != null" class="row mt-4">
                                            <div class="col pl-0">
                                                <h2 class="mb-2">Special Instructions:</h2>
                                                <p class="text-muted">{{job.special_instruction}}</p>
                                            </div>
                                        </div>
                                        <div v-show="job.preferred_gender != null" class="row mt-4">
                                            <div class="col pl-0">
                                                <h2 class="mb-2">Preferred Gender:</h2>
                                                <div class="text-muted">
                                                    <div v-if="job.preferred_gender == 10">Male</div>
                                                    <div v-if="job.preferred_gender == 20">Female</div>
                                                    <div v-if="job.preferred_gender == 30">Both</div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row mt-4 text-center">
                                            <div class="col">
                                                <button data-toggle="modal" data-target="#applyNow" class="btn btn-outline-success">Apply now</button>
                                            </div>
                                        </div>
                                            ...
                                            <div class="modal-body">
                                                <div class="innerbody apply-jobbox">
                                                    <form class="form-group">
                                                        ...
                                                        <textarea class="form-control" v-model="coverLetter" name="coverLetter" id="" cols="30" rows="7" placeholder="Cover Letter"></textarea>
                                                    </form>
...
export default {
    ...
    mounted() {
        localStorage.setItem('checkJobUrl', JSON.stringify('single-job'));
    ...
    methods: {   
          get_job(){
            ...
            axios({ method: "GET", url: "/api/get-job/"+ this.url
            }).then(
                result => {                    
        ...
        job_apply(jobId){
            ...
            axios.post('/api/job-apply', {
                jobId,
                userId: JSON.parse(localStorage.getItem('TTNetwork.user')).id,
