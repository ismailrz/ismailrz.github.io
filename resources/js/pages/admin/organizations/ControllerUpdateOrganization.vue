		...
		<div id="content-wrapper" class="d-flex flex-column">
			<div id="content">
				...
				<div class="container-fluid" >
                  ...
                  <p class="text-center h3 text-primary font-weight-bold">Update organization</p>
								</div>
								<div class="card-body">
...
export default {
  name: 'ControllerUpdateOrganization',
  mixins: [ScriptLoader],
  components: {
    HeaderBar,
    LeftSidebar,
  ...
  methods: {
    ...
    getData() {
      ...
      axios({ method: "GET", url: "/api/organizations/" + organization_id }).then(
        response => {
    ...
    update(id) {
      let organization_id = window.location.href.split('/').pop();
      axios.put(`/api/organizations/${organization_id}`, {
