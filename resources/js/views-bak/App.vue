<template>
    <div>
        <nav class="navbar navbar-expand-md navbar-light navbar-laravel">
            <div class="container">
                <!-- <router-link :to="{name: 'home'}" class="navbar-brand">TTN</router-link>
...
export default {
    data() {
        return {
            name: null,
            user_type: 0,
            isLoggedIn: localStorage.getItem('TTNetwork.jwt') != null
        }
    },
    mounted() {
        this.setDefaults()
    ...
    methods : {
        ...
        change() {
            this.isLoggedIn = localStorage.getItem('TTNetwork.jwt') != null
            this.setDefaults()
        },
        logout(){
